...
export const metadata = {
  ...
  keywords: [
    ...
    "dekorasi pernikahan",
    "paket pernikahan",
    "rias pengantin indramayu",
    "wedding organizer indramayu",
    "mua indramayu",
    "gaun pengantin indramayu",
    "sewa busana adat",
    "perlengkapan akad",
    "paket resepsi indramayu",
    "fotografi pernikahan",
    "videografi pernikahan",
    "prewedding indramayu",
    "wedding venue indramayu",
    "wedding planner jawa barat",
    "dekorasi pelaminan",
    "wedding styling",
    "rental kebaya modern",
    "sewa jas pengantin",
    "makeup wisuda",
    "rias lamaran",
    "rias siraman",
